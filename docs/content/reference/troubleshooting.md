...
Most of these come down to network reality or how usgswaterservices serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

usgswaterservices rate-limits like any public site. usgswater already paces
...
Where a surface is gated, usgswater reads a cookie or token you supply
...
`usgswater`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what usgswater actually did
