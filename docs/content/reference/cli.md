...
```
usgswater <command> [arguments] [flags]
```

Run `usgswater <command> --help` for the full flag list on any command. This
...
per operation you declare in `usgswaterservices/domain.go`.
